...
::: tip Returning a stoploss relative to the open price from the custom stoploss function
...
::: tip Returning a stoploss using absolute price from the custom stoploss function
